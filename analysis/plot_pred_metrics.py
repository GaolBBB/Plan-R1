...
#   --csv /home/gaosunxiang/Plan-R1/lightning_logs/pred/version_0/metrics.csv \
#   --outdir /home/gaosunxiang/Plan-R1/lightning_logs/pred/version_0/plots_ul_weight1 \
#   --smooth 50
def _to_numeric(s):
...
def main():
    ...
    save_line_plot(df, "step", "train_ul_loss_step",
                   os.path.join(args.outdir, "train_ul_loss_step_log.png"),
                   title="train_ul_loss_step vs step (log y)", y_log=True, smooth=args.smooth)
    ...
    if not sub.empty:
        ...
        plt.xlabel("step")
        plt.ylabel("train_ul_loss_step / train_cls_loss_step")
        plt.title("UL/CLS ratio vs step (useful for choosing sft_ul_weight)")
        plt.grid(True, alpha=0.3)
        plt.tight_layout()
        ...
        if median_ratio > 0:
            ...
            print(f"[INFO] median(UL/CLS) = {median_ratio:.6g}")
